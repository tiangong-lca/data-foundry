...
test("published CLI resolver binds the installed 0.1.2 package bin through Node", () => {
  ...
  try {
    ...
    assert.equal(cli.package, "@tiangong-lca/cli@0.1.2");
    assert.equal(cli.package_version, "0.1.2");
