...
test("published CLI resolver binds the installed 0.1.13 package bin through Node", () => {
  ...
  try {
    ...
    assert.equal(cli.package, "@tiangong-lca/cli@0.1.13");
    assert.equal(cli.package_version, "0.1.13");
