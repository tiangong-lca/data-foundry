...
const stems = [
  "content-policy-profile-waiver",
  "foundry-stage-contract",
...
test("runtime skill, stage, and content policy unit tests are native TypeScript", () => {
...
test("runtime and policy governance no longer names legacy unit-test paths", () => {
