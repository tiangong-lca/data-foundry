...
test("active documentation and source contain no references to removed CLI spine modules", () => {
  const removedModulePaths = [
    ...
    "mutation-manifest-workflow.mjs",
    "mutation-manifest.mjs",
    "commands/tasks.mjs",
    "commands/import-completion.mjs",
    "commands/commit-handoff.mjs",
    "commands/identity-decision-task.mjs",
    "commands/support-cache.mjs",
    ...
    "commands/bafu-process-scope-e2e.mjs",
    "commands/bafu-batch-import-run.mjs",
  ];
  const files = [
    "AGENTS.md",
    "README.md",
