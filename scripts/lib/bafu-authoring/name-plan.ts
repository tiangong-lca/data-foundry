...
interface MarketMixPart {
  base_name: string;
  mix_location: string;
}

export interface BafuNamePlan {
  source: string;
  base_name: string;
  treatment: string;
  mix_location?: string;
  flow_property?: string;
  clean_existing_treatment?: boolean;
}
...
function splitCommaDelimitedMarketMixPart(value: unknown): MarketMixPart | null {
