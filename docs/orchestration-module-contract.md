...
lastReviewedNote: "Reviewed for Issue #80: exact recovery argv authority and projector-drift rejection remain byte-pinned, single-source, bounded, and cycle-free."
related:
