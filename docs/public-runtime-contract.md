...
Sealing rechecks identity freshness after local handoff preparation and asks the qualified CLI for a fresh identity if the original receipt has expired. It then performs the existing complete capsule admission against the current grant and evidence.
