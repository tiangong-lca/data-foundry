...
| Foundry package/compiler and typed migration spine | `tiangong-lca-data-foundry` | Node.js 24, `pnpm@11.23.0`, TypeScript `7.0.2`, Oxlint, immutable-baseline `specs/typescript-migration-inventory.json`, clean arbitrary-worktree gates, and merge-base Golden comparison |
