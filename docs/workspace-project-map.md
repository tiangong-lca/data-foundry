...
| Foundry package/compiler and typed migration spine | `tiangong-lca-data-foundry` | Node.js 24, `pnpm@11.23.0`, TypeScript `7.0.2`, Oxlint, `specs/typescript-migration-inventory.json`, and clean arbitrary-worktree gates |
