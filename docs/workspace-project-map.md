...
lastReviewedNote: "Reviewed for Issue #67 explicit-any proof hardening: target lint and semantic evidence types remain Foundry-local; Rust tidas, CLI/database/search/readback and cross-repository boundaries are unchanged."
---
