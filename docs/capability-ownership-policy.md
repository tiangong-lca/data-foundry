...
lastReviewedNote: "Reviewed for Issue #67 Wave 20: typed row-transform context remains Foundry-owned lineage proof and adds no sibling transform, CLI or database behavior."
---
