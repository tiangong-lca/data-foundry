...
lastReviewedNote: "Reviewed for Issue #67 Wave 15: typed decision apply context remains Foundry-owned local evidence aggregation and adds no sibling decision, CLI or database behavior."
---
