...
lastReviewedNote: "Reviewed for #100 CLI C1 adoption: reusable runtime identity stays CLI-owned; Foundry task/profile/gate ownership and adapter routing are unchanged."
---
