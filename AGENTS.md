...
lastReviewedNote: "Reviewed for Issue #70: the BAFU/USLCI/Worldsteel owner delegates bounded claims, family resource serialization, pause/stop, drain, and run locking to CLI 0.1.3 while retaining LCA semantics and ledgers."
---
