...
- The characterized TypeScript leaves include the CLI parser/registry/metadata/surface audit plus bundle row types, TIDAS language enumeration, exact JSON/text hashing, and dataset-type constants. Focused tests pin parser/help/exit behavior, metadata/report schemas, portable import auditing, root/table/type mappings, language detection, hash serialization order, invalid inputs, and every static consumer.
