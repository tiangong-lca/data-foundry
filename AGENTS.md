...
lastReviewedNote: "Reviewed for Issue #70: Foundry pins verified CLI 0.1.3 and consumes batch, run-lock, CommandSpec, and auth receipt parsing only through public package subpaths on exact pnpm 11.24.0."
---
